...
DATASET_NAME = os.path.join("C:","Users","onion","PycharmProjects","news_analysis","database","dbs","censored_titles_set")
...
class Saver:
    ...
    def save(self, article):
        #print("SAVING:")
        with open("C:\\Users\\onion\\PycharmProjects\\news_analysis\\database\\dbs\\censored_titles_set\\" + str(Saver.totalcount) + '.txt', 'w', encoding='utf-8') as F:
