...
#if not os.path.isdir(os.path.join( "jsvnews", "ABSA_BERT_MODEL", "data")):
#    raise NotADirectoryError(os.path.join( "jsvnews", "ABSA_BERT_MODEL", "data") )

tokenizer = BertTokenizer.from_pretrained('bert-base-uncased', do_lower_case=True, cache_dir=os.path.join('jsvnews', 'lib', 'ABSA_BERT_MODEL', "cache"))
